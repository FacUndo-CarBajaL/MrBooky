...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(90, 34);
			...
			this->label2->Size = System::Drawing::Size(123, 30);
...
#pragma endregion
	...
	private: System::Void RobotApprove_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		for (int i = 0; i < DeliveryPointQuantity; i++) {
			...
			CreatePictureBox(DeliveryPointName, x, y, 90, 90, "Imagenes/DiseñoIconos/ImgDeliveryPoint.png");
		}
	}
