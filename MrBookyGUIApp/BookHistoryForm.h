...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(349, 15);
			...
			this->dgvHistorial->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(7) {
				this->ColumnaID,
					this->ColumnaTitulo, this->ColumnaAutor, this->ColumnaEditorial, this->ColumnaFechaPrestamo, this->ColumnaImagen, this->ColumnaAñadirReseña
			});
			this->dgvHistorial->Location = System::Drawing::Point(29, 78);
			...
			this->ClientSize = System::Drawing::Size(1109, 450);
